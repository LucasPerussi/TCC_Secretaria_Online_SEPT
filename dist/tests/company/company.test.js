...
describe('Company API', () => {
    ...
    describe('GET /companies/id/:id', () => {
        it('deve retornar os dados de uma empresa específica', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app_1.app)
                .get(`/companies/id/${createdCompanyId}`)
                .set('Authorization', `${token}`);
        ...
        it('deve retornar erro ao buscar uma empresa inexistente', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('GET /companies/all', () => {
        it('deve retornar todas as empresas', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app_1.app)
                .get('/companies/all')
                .set('Authorization', `${token}`);
